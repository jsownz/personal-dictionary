...
Development is ongoing and relative to the scope of desired functionality the current release is in alpha. Hopefully this project will be deprecated through education of password management programs, or altogether replacing the insecure concept of a password.
