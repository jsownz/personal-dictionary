...
Manifest Dictionary quickly generates an intelligent wordlist using permutations of terms entered into a JSON template. The template can be manually edited or populated dynamically when ManifestDictionary.py is ran. Terms are intended to be accumulated during information gathering phase of a penetration test. The more relevant the terms, the higher chance of success. View the contents of 'config.json' for further clarity.
